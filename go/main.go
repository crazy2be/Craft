...
//     if (!glfw.CreateWindow(800, 600, 8, 8, 8, 0, 24, 0, GLFW_WINDOW)) {
//         return -1;
//     }
	var err error
...
//     }
    ...
    vertex_shader := load_shader(gl.VERTEX_SHADER, "vertex.sl");
    fragment_shader := load_shader(gl.FRAGMENT_SHADER, "fragment.sl");
